...
use App\Modules\Task\Application\UseCases\UpdateTask;
...
new class extends Component
{
    ...
    public function boot(UpdateTask $updateTask): void
    {
    ...
    public function save(): void
    {
        ...
        $task = $this->updateTask->handle($this->task, UpdateTaskData::fromArray([
