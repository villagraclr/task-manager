...
new class extends Component
{
    ...
    public function boot(CreateProject $createProject): void
    {
    ...
    public function save(): void
    {
        ...
        try {
            $project = $this->createProject->handle(CreateProjectData::fromArray([
                'name' => $this->name,
        ...
        session()->flash('status', "Proyecto \"{$project->name}\" creado.");
...
<div>
    <h1 class="text-2xl font-semibold mb-6">Nuevo proyecto</h1>
    ...
    <form wire:submit="save" class="max-w-lg space-y-4">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('projects.index') }}" wire:navigate class="text-sm text-gray-600 hover:underline">
                Cancelar
            </a>
        </div>
    </form>
