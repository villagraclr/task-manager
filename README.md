...
| Rama | Enfoque |
|---|---|
| `layered` | Arquitectura por capas: Model (Eloquent) → Repository → Service → Policy → Livewire Component |
| `hexagonal` | Ports & Adapters por módulo/bounded context: Domain → Application (Use Cases) → Infrastructure → UI |
